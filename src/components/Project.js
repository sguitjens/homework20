  ...
  return (
    ...
    <div className="card h-100">
      ...
      <div className="card-body d-flex flex-column">
        ...
        <a href={props.gitHubURL} alt={props.altText} target="_blank" rel="noopener noreferrer" className="btn btn-info btn-lg btn-block active img-caption mt-auto" role="button" id="img-btn">{props.label}</a>
      </div>
    </div>
