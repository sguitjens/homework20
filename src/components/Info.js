    ...
    <div className="col-md-8 offset-md-1 mid-body">
      ...
      <div className="col-md-12">
        ...
        <p>
          ...
          {/* <a href="https://www.linkedin.com/in/sydneyguitjens/" alt="LinkedIn" target="_blank"><i className="fab fa-linkedin"/></i> LinkedIn</a> <br> */}
          {/* <a href="https://github.com/sguitjens" alt="github" target="_blank"><i className="fab fa-github-alt"></i> GitHub</a><br> */}
          <a href="/pdf/Guitjens_Sydney_Resume.pdf" alt="Resume PDF" target="_blank"><i className="fas fa-file-pdf"></i> Resume PDF</a>
        </p>
      </div>
    </div>
  )
